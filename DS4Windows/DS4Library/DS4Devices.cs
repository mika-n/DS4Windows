...
namespace DS4Windows
{
    ...
    public class DS4Devices
    {
        ...
        private static VidPidInfo[] knownDevices =
        {
            ...
            new VidPidInfo(0x7331, 0x0001, "DualShock 3 (DS4 mode)", InputDeviceType.DS4, VidPidFeatureSet.NoGyroCalib), // PlayStation3 DualShock3 using DsHidMini driver. Requires https://vigem.org/projects/DsHidMini/ (this is the only thing needed in DS3 USB connection). DS3 BT connection requires both DsHidMini and BthPS3
        };
