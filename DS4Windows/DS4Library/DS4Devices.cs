...
namespace DS4Windows
{
    ...
    public class DS4Devices
    {
        ...
        private static VidPidInfo[] knownDevices =
        {
            ...
            new VidPidInfo(0x7331, 0x0001, "DualShock 3 (DS4 mode)", InputDeviceType.DS4, VidPidFeatureSet.NoGyroCalib), // Sony DualShock 3 running DsHidMini driver. Requires https://vigem.org/projects/DsHidMini/ driver (USB and BT). If DS3 is connected over BT then requires additional BthPs3 driver also.
        };
